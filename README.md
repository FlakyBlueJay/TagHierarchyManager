...
### LLM Use
Anthropic's Claude LLMs (Sonnet 4.6, Opus 4.7) has been used by myself to improve performance and reliability of the code, and due to personal medical reasons.
